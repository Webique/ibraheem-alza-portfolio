...
const Partners = () => {
  ...
  useEffect(() => {
    ...
    const scrollSpeed = 0.3; // Very slow and stable
    ...
    const scroll = () => {
      try {
        ...
        // If any error occurs, stop scrolling
        console.log('Scrolling stopped due to error');
      }
    };

    // Very slow interval for maximum stability
    const intervalId = setInterval(scroll, 150);
  ...
  return (
    <section id="partners" className="section-padding bg-muted/20">
      <div className="container-width">
        ...
        {/* Partners Horizontal Bar - Safe Auto-scrolling */}
        <div className="mb-16 overflow-hidden">
          <div 
            ...
            style={{ 
              width: 'max-content',
              minWidth: '150%' // Ensure there's enough content to scroll
            }}
          >
